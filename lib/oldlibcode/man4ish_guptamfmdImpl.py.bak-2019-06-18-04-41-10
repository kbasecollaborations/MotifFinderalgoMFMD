...
#import man4ish_guptamfmd.Utils.MotifParserUtils as MPU
#from man4ish_guptamfmd.Utils.MotifParserUtils import MotifParserUtils as MPU
...
class man4ish_guptamfmd:
    ...
    def find_motifs(self, ctx, params):
        ...
        mfmdMotifCommand = HU.build_mfmd_command(FastaFilePath,motlen,prb,self.config)
        ...
        #mfmd_out_path = '/kb/module/work/tmp/mfmd/mfmd_out'
        ...
        mfmd_params['prb'] = prb
        #obj_ref = HU.UploadFrommfmd(self.callback_url, mfmd_params)
        #exit(obj_ref)
        obj_ref = HU.UploadFrommfmd(self.callback_url, mfmd_params)[0]['obj_ref']
        #print("+++")
        #print(obj_ref)
        #print("+++")
        #obj_ref = HU.UploadFrommfmd(mfmd_params)['obj_ref']
        #obj_ref = MPU.UploadFrommfmd(mfmd_params)['obj_ref']      #add this function to parse the data from software
